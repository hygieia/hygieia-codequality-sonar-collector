...
public class SonarClientSelector {
    ...
    private DefaultSonar83Client sonar83Client;
    ...
    public SonarClientSelector(
    		DefaultSonar83Client sonar83Client, DefaultSonar6Client sonar6Client, DefaultSonar56Client sonar56Client,
            @Qualifier("DefaultSonarClient") DefaultSonarClient sonarClient,
            Supplier<RestOperations> restOperationsSupplier) {

        this.sonar83Client = sonar83Client;
    ...
    public SonarClient getSonarClient(Double version) {
        ...
        if (version != null && version >= 8.3){
            return sonar83Client;
        }
